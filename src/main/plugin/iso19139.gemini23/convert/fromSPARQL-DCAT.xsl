...
<xsl:stylesheet xmlns:gmd="http://www.isotc211.org/2005/gmd"
  ...
  <!-- Converted from
  https://github.com/geonetwork/core-geonetwork/blob/main/schemas/iso19115-3.2018/src/main/plugin/iso19115-3.2018/convert/fromSPARQL-DCAT.xsl
    ...
    <xsl:for-each
      ...
      <gmd:MD_Metadata>
        ...
        <xsl:variable name="dateStamp"
          select="format-dateTime(current-dateTime(), '[Y0001]-[M01]-[D01]T[h1]:[m01]:[s01]')" />
                  ...
                  <gmd:MD_DigitalTransferOptions>
                    ...
                    <gmd:onLine>
                      <gmd:CI_OnlineResource>
                        ...
                        <gmd:description>
                          <gco:CharacterString>A link to the CKAN metadata record on the Spatial
    Hub.</gco:CharacterString>
                        </gmd:description>
                        <gmd:function>
                          <gmd:CI_OnLineFunctionCode
